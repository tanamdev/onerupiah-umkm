  ...
  try {
    ...
    const updated = await prisma.package.update({
      ...
      data: {
        ...
        ...(imagesPerGeneration !== undefined && {
          imagesPerGeneration: Number(imagesPerGeneration),
        }),
  ...
  try {
    ...
    if (existing._count.subscriptions > 0 || existing._count.transactions > 0) {
      ...
      return NextResponse.json({
        ...
        data: deactivated,
        message:
          'Paket dinonaktifkan karena masih terkait dengan subscription/transaksi aktif',
      });
    }
