...
export class ApiClient {
  ...
  async post<T>(url: string, data?: any, schema?: ZodSchema<T>): Promise<T> {
  ...
  async put<T>(url: string, data?: any, schema?: ZodSchema<T>): Promise<T> {
  ...
  async patch<T>(url: string, data?: any, schema?: ZodSchema<T>): Promise<T> {
